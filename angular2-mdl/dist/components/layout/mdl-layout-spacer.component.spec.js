...
describe('Component: MdlLayoutSpacer', function () {
    beforeEach(function () {
    ...
    it('should add the css class mdl-layout-sapcer to the host element', function () {
        var fixture = testing_1.TestBed.createComponent(MdlTestComponent);
        fixture.detectChanges();
        var spacerEl = fixture.nativeElement.children.item(0);
...
//# sourceMappingURL=../../../dist/components/layout/mdl-layout-spacer.component.spec.js.map