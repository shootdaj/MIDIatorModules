...
describe('Component: MdlLayoutHeaderRow', function () {
    beforeEach(function () {
    ...
    it('should add the css class mdl-layout__header-row to the header element', function () {
        var fixture = testing_1.TestBed.createComponent(MdlTestComponent);
        fixture.detectChanges();
        var headerEl = fixture.nativeElement.children.item(0);
...
//# sourceMappingURL=../../../dist/components/layout/mdl-layout-header-row.component.spec.js.map